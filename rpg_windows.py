...
casa = False
portaSotao = False
password = "5797879787972372737832783289239283293893829823928392833929777382392739273293823923847923872392382793276" \
           "1797293823972837938293238293837293872327329382392382392832973823293829327327329328392382938239283297382" \
           "3923829382392382937237293823923829732732932739823792394"
...
def testarSenha(senha, original):
    ...
    destravou = senhaSemEspaco == original
...
while True:
    ...
    # usar e destrancar
        ...
        if items[1][3]:
            ...
            valoresLocais[1] = 2
            comando = imprimirDescricao(mapaLocais[valoresLocais[0]][valoresLocais[1]])
    elif testarSeExiste(comando, ["abrir", "destrancar"]) and testarSeExiste(comando, ["baú", "bau"])\
    ...
    # mapa
        ...
        valoresLocais[1] = 0
        comando = imprimirDescricao(mapaLocais[valoresLocais[0]][valoresLocais[1]])
    elif testarSeExiste(comando, ["sotão", "sotao", "sótão"]) and valoresLocais[0] == 5 and casa:  # ir sotão
        valoresLocais[0] = 6
        valoresLocais[1] = 0
        comando = imprimirDescricao(mapaLocais[valoresLocais[0]][valoresLocais[1]])
